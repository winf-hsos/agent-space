...
echo "  1. npm install -g opencode-ai && opencode auth login"
echo "  2. cp $BRIDGE_DIR/.env.example $BRIDGE_DIR/.env"
echo "     nano $BRIDGE_DIR/.env          # add real bot tokens"
echo "  3. cp $BRIDGE_DIR/bots.yaml.example $BRIDGE_DIR/bots.yaml"
